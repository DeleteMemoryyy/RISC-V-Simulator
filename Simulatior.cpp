                                            ...
                                            switch (selected_size)
                                                {
                                                    case 0:
                                                        {
                                                            ...
                                                            int stop = (endAddr>= MEM_ED)?((MEM_ED-endAddr)):100;
                                                    ...
                                                    case 1:
                                                        {
                                                            ULL endAddr =(V_TO_P(memAddr + 2 * 100));
                                                            int stop = (endAddr>= MEM_ED)?(MEM_ED-endAddr)/2: 100;
                                                            for(int i=0;i<stop;++i)
                                                            {
                                                                ImGui::Text(
                                                                    "0x%llx: 0x%x",
                                                                    memAddr + 2 * i,
                                                                    READ_HWORD(memAddr + 2 * i));
                                                            }
                                                        }
                                                        break;
                                                    case 2:
                                                        {
                                                            ULL endAddr =(V_TO_P(memAddr + 4 * 100));
                                                            int stop = (endAddr>= MEM_ED)?(MEM_ED-endAddr)/4: 100;
                                                            for(int i=0;i<stop;++i)
                                                            {
                                                                ImGui::Text(
                                                                    "0x%llx: 0x%x",
                                                    ...
                                                    case 3:
                                                        {
                                                            ULL endAddr =(V_TO_P(memAddr + 8 * 100));
                                                            int stop = (endAddr>= MEM_ED)?(MEM_ED-endAddr)/8: 100;
                                                            for(int i=0;i<stop;++i)
                                                            {
                                                                ImGui::Text(
                                                                    "0x%llx: 0x%llx",
                                                                    memAddr + 8 * i,
                                                                    READ_DWORD(memAddr + 8 * i));
                                                            }
                                                        }
                                                        break;
                                                    default:
